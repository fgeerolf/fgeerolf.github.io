---
title: Lecture 2 - Replicating Mian and Sufi
subtitle: UCLA - Econ 221 - Fall 2018
...
- \fancyhf{}
- \fancyfoot[C]{\thepage}
- \fancyhead[L]{UCLA - Econ 221 - Fall 2018 - Geerolf}
- \fancyhead[R]{Replicating Mian and Sufi}
output:
  pdf_document:
...
During this lecture, we do some "hands-on" data work based on the following academic articles:
...
We attempt to replicate the results in the above papers, using R Statistical Software. You should read [this introduction to R](R.html) first. We load the needed packages: `curl` to download, `tidyverse` to manipulate data, `foreign` to import stata datasets, and `AER` to run IV regressions.
